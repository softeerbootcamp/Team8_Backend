...
export declare type PaymentRequestWithoutUrl = CommonPaymentRequestWithoutUrl | CardPaymentRequestWithoutUrl | VirtualAccountPaymentRequestWithoutUrl | TranferPaymentRequestWithoutUrl;
export declare function isPaymentRequest(params: unknown): params is PaymentRequest;
